                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12 mb-4">
                                    ...
                                    <input type="description" class="form-control" id="description"
                                        wire:model="description" placeholder="Appunti Aggiuntivi">
                                </div>
                                <div class="col-12 col-md-4 mb-4">
                                ...
                                <div class="col-12 col-md-4 mb-4">
                                    <label for="daphne" class="form-label">DAPHNE:</label>
                                ...
                                <div class="col-12 col-md-4 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="tempo_daphne" wire:model="tempo_daphne"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="row mb-5 pb-2">
                                ...
                                <div class="col-12 col-md-6 mb-4">
                                    ...
                                    <input type="wo_number" class="form-control" id="wo_number" wire:model="wo_number"
                                        placeholder="">
                                </div>
                                <div class="col-12 col-md-6 mb-4">
                                ...
                                <div class="col-12 col-md-12 mb-4">
                                    ...
                                    <textarea class="form-control" id="suspension_history" rows="5"
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-12">
                                    @include('livewire.partials.chunked-media-upload')
                                </div>
