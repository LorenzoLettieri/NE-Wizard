                ...
                <header class="hero-header position-relative text-white mb-4">
                    ...
                    <div class="hero-content position-absolute top-50 start-0 translate-middle-y px-5">
                        <div class="bg-dark bg-opacity-50 p-4 rounded shadow-lg">
                            <h1 class="display-4 fw-bold m-0">Ciao, <span
                                    class="text-primary">{{ Auth::user()->name }}</span></h1>
                        </div>
                    </div>
                </header>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="border border-black rounded-4 p-4 shadow-lg">
                                ...
                                <ul class="list-unstyled m-0">
                                    <li class="mb-2"><i class="bi bi-calendar-date text-primary me-2"></i> Export in excel
                                        per un sacco di cose!</i></li>
                                    <li class="mb-2"><i class="bi bi-calendar-check text-primary me-2"></i> Aggiunta
                                        timbratura e report presenze!</i></li>
                                    <li class="mb-2"><i class="bi bi-shield text-primary me-2"></i> Aggiunta zona profilo
                                        con cambio password! Clicca sul tuo nome!</i></li>
                                    <li class="mb-2"><i class="bi bi-pen text-primary me-2"></i> Qualche modifica generale
                                        allo stile tipo icone varie, spero di non aver rotto niente!</i></li>
                                </ul>
                            </div>
                        </div>
                    </div>
